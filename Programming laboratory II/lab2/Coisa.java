...
* Classe principal responsável por criar os objetos das classes ContaLaboratorio,
* Disciplina, ContaCantina e Saude. Além disso, responsável também pela manipulação
* dos estados dos respectivos objetos criados.
*
...
public class Coisa {
    ...
    public static void main(String[] args) {
		...
		ContaLaboratorio contaLCC2 = new ContaLaboratorio("LCC2", 2000);
